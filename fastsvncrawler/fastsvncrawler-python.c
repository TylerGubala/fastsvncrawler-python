...
/*
End EVN crawler sources
*/

static char module_docstring[] =
    "Efficient `svn` traversal for python";
static char crawl_method_docstring[] =
    "Test";

static PyObject *py_crawl(PyObject *self, PyObject *args) {
    return args;
};

static PyMethodDef module_methods[] = {
    {"crawl", py_crawl, METH_VARARGS, crawl_method_docstring},
    {NULL, NULL, 0, NULL}
};

static struct PyModuleDef module = {
    PyModuleDef_HEAD_INIT,
    "fastsvncrawler",   /* name of module */
...
PyMODINIT_FUNC PyInit_fastsvncrawler(void)
{
